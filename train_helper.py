...
#TRAINING THE MODEL
def train_model(model, learn_rate, epochs, train_loader, valid_loader, device, hidden_units, hidden_units2):
...
def save_checkp(model, train_datasets, epochs, directory, arch, learn_rate):
    optimizer = optim.Adam(model.classifier.parameters(), lr=learn_rate)
